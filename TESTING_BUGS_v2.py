...
SHUNT_OHMS = {
    "F1": float(os.environ.get("SHUNT_OHMS_F1", "149.5")),
    "F2": float(os.environ.get("SHUNT_OHMS_F2", "149.5")),
    "F3": float(os.environ.get("SHUNT_OHMS_F3", "148.5")),
}
...
class App(ctk.CTk):
    ...
    def open_flow_plot(self, fermenter):
        ...
        ttk.Label(stats, textvariable=current_var, font=("Segoe UI", 12)).grid(row=1, column=1, sticky="w")
        ttk.Label(stats, text="Voltaje:", font=("Segoe UI", 12, "bold")).grid(row=2, column=0, sticky="w")
        ttk.Label(stats, textvariable=voltage_var, font=("Segoe UI", 12)).grid(row=2, column=1, sticky="w")
        ttk.Label(stats, text="Estado:", font=("Segoe UI", 12, "bold")).grid(row=3, column=0, sticky="w")
        ttk.Label(stats, textvariable=status_var, font=("Segoe UI", 12)).grid(row=3, column=1, sticky="w")
        ttk.Label(stats, text="Siguiente muestra:", font=("Segoe UI", 12, "bold")).grid(row=4, column=0, sticky="w")
        ttk.Label(stats, textvariable=next_var, font=("Segoe UI", 12)).grid(row=4, column=1, sticky="w")
        ...
        def update_stats():
            ...
            voltage_var.set(f"{voltage:0.2f} V")

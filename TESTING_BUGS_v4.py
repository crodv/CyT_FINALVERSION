...
DEFAULT_SHUNT_OHMS = float(os.environ.get("SHUNT_OHMS", "141.3"))
SHUNT_OHMS = {
    "F1": float(os.environ.get("SHUNT_OHMS_F1", "140.0")),
    "F2": float(os.environ.get("SHUNT_OHMS_F2", "140.0")),
    "F3": float(os.environ.get("SHUNT_OHMS_F3", "130.0")),
}
...
class App(ctk.CTk):
    ...
    def _log_flowmeters_status(self):
        print("[CO2] Diagnóstico ADS1115 (AIN1/AIN2/AIN3):")
        ok_count = 0
        for name in ("F1", "F2", "F3"):
